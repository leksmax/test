...
{
	var menu_div, vpn_div, site_div;
	var content_length;

	menu_div = top.document.getElementById("adv_home");
	settingClass(menu_div, "advanced_black_button");
	vpn_div = top.document.getElementById("vpnCenter");
	settingClass(vpn_div, "advanced_black_button");
	site_div = top.document.getElementById("sideToSide");
	settingClass(site_div, "advanced_black_button");
...
function menu_color_change( change_id )
{
	...
	if( change_id == "adv_home" ||  change_id == "adv_setup_wizard" || change_id == "adv_wps" || change_id == "vpnCenter" || change_id == "sideToSide")
	{
...
function click_adv_action(id)
{
	if(id == "adv_setup_wizard")
		...
		else if( id == "vpnCenter" )
		{
			goto_formframe("vpn/vpn.html");
			menu_color_change('vpnCenter');
		}else if( id == "sideToSide")
		{
			goto_formframe("site/site.html");
			menu_color_change('sideToSide');
		}
        }
	change_menu_height();
}
