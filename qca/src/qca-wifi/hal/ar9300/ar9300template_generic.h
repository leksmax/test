...
static ar9300_eeprom_t ar9300_template_generic =
{
	...
	//static JET_MODAL_EEP_HEADER modal_header_2g=
	{
		    ...
		    {0x150,0x150,0x150,0x150},	//  ant_ctrl_chain[JET_MAX_CHAINS];       // 6   idle, t, r, rx1, rx12, b (2 bits each)
...
static osprey_eeprom_t ar9300_template_osprey =
{

	2, //  eeprom_version;

    ar9300_eeprom_template_osprey, //  template_version;
