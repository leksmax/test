...
#define ABS(_x, _y) ((int)_x > (int)_y ? (int)_x - (int)_y : (int)_y - (int)_x)
    ...
    if (is_2g) {
        ...
        if (AR_SREV_HORNET(ah) || AR_SREV_WASP(ah) || AR_SREV_JUPITER(ah) || AR_SREV_APHRODITE(ah)) {
            ...
            if (is_ht40) {
                ...
                am_mask = ahp->ah_2g_paprd_rate_mask_ht40 & AH_PAPRD_AM_PM_MASK;
                am_mask_4ss = ahp->ah_2g_paprd_rate_mask_4ss_ht40 & AH_PAPRD_AM_PM_4SS_MASK;
                if (AR_SREV_JET(ah) && (ahp->ah_eeprom.base_ext1.eep_paprd_trainning_power != 0))
                    ahp->paprd_training_power = ahp->ah_eeprom.base_ext1.eep_paprd_trainning_power;// EEP file: set paprdtrainpower=decimal
                else
                ...
                if (AR_SREV_JET(ah) && (ahp->ah_eeprom.base_ext1.eep_paprd_trainning_power != 0))
                    ...
                    ahp->paprd_training_power = 34; //target_power_val_t2[ALL_TARGET_LEGACY_54];
            }
    ...
    OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_AM2AM, AR_PHY_PAPRD_AM2AM_MASK,
        am_mask);
    OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_4SS_MASK, AR_PHY_PAPRD_AM2AM_4SS_MASK,
        am_mask_4ss);
    ...
    if (AR_SREV_DRAGONFLY(ah) || AR_SREV_HONEYBEE(ah) || AR_SREV_JET(ah)) {
        OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_HT40, AR_PHY_PAPRD_HT40_MASK,
            am_mask);
        OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_4SS_MASK, AR_PHY_PAPRD_HT40_4SS_MASK,
            am_mask_4ss);
    }
    else {
        OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_HT40, AR_PHY_PAPRD_HT40_MASK,
    ...
    if (AR_SREV_DRAGONFLY(ah)) {
        ...
        if (AH9300(ah)->ah_tx_chainmask & AR9300_CHAIN3_MASK) {
            ...
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH3_BB3,
                AR_PHY_65NM_CH3_BB3_SPARE, 0x54);
        }
#endif
    }
