...
int ieee80211_ucfg_setparam(wlan_if_t vap, int param, int value, char *extra)
{
	...
	if (value == IEEE80211_AUTH_OPEN)
        {
            wlan_mlme_app_ie_delete_id(vap->vie_handle, IEEE80211_FRAME_TYPE_BEACON, HOSTAPD_WPS_IE);
            wlan_mlme_app_ie_delete_id(vap->vie_handle, IEEE80211_FRAME_TYPE_PROBERESP, HOSTAPD_WPS_IE);
        }
#ifdef ATH_SUPPORT_P2P
