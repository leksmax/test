...
//This is an auto-generated file, from the given header file ../../../common/tlv1/include/cmdNartGenericCmdParms.h //for parsing the tx cmd parms in the binary stream
