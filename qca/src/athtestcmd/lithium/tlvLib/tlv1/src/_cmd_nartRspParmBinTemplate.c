...
//This is an auto-generated file, from the given header file ../../../common/tlv1/include/cmdNartGenericRspParms.h //for parsing the tx cmd parms in the binary stream
